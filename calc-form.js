...
class CalcForm extends HTMLFormElement {
  ...
  connectedCallback() {
    ...
    this.addSelect({ "2": "2 Years", "3": "3 Years", "4": "4 Years" }, "term", "term");
    this.addLabel("term", "Term");

    this.addInput("number", "age", { id: "age", max: 100, required: true});
    this.addLabel("age", "What is your age?");

    this.addSelect({ "n": "No", "y": "Yes" }, "smoker1", "smoker1");
    this.addLabel("smoker1", "Are you a smoker?");

    this.addInput("number", "age2", {id: "age2", max: 100, required: true});
    this.addLabel("age2", "Age of person two");

    this.addSelect({ "n": "No", "y": "Yes" }, "smoker2", "smoker2");
